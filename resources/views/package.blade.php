...
<div class="container">
    <div>
        ...
        <div class="mt-6 p-16 bg-[url('/public/img/order_bg.jpg')] bg-center bg-cover">
            ...
            <form id="orderForm" method="post" action="/order" class="mt-12 w-full md:w-2/4 mx-auto p-12 bg-black shadow-lg shadow-black">
                @csrf
                <input type="hidden" name="package" value="{{$package->id}}">
                <div class="mb-4">
                    <label for="name" class="block text-sm font-medium">Имя</label>
                    <input type="text" id="name" name="name" required
                           class="mt-1 block w-full text-black p-2 bg-white bg-opacity-80 focus:outline-none focus:ring focus:ring-green-300"
                ...
                <div class="mb-4">
                    ...
                    <input type="tel" id="phone" name="phone" required
                           class="mt-1 block w-full p-2 text-black bg-white bg-opacity-80  focus:outline-none focus:ring focus:ring-green-300"
